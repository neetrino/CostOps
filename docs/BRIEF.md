...
- No separate Figma file. Visual baseline is the live Neon dashboard: https://neon-neetrino.vercel.app
- Reuse layout, filters, KPI strip, charts, cards/list, inline budget fields
