      ...
      <div className="scrollbar-none flex snap-x gap-3 overflow-x-auto pb-2 sm:grid sm:grid-cols-2 sm:overflow-visible xl:grid-cols-4">
        {tiles.map((tile, index) => (
          <motion.div
            ...
            className={`relative flex min-h-44 min-w-[76vw] snap-start flex-col overflow-hidden rounded-[var(--radius)] border border-[var(--line)] p-5 shadow-[var(--shadow-card)] sm:min-w-0 ${tileTone(index)}`}
          >
