...
export function ProjectPicker({
  ...
  const triggerClassName = `flex min-h-10 w-full items-center justify-between gap-3 rounded-[var(--radius-sm)] border bg-[var(--paper-raised)] px-3 py-2 text-left text-sm transition-colors hover:border-[var(--accent)] ${
      ...
      <div className="hidden sm:block">
        ...
        >
          ...
          <Popover
            ...
            offset={4}
            className="z-[80] w-[var(--trigger-width)] overflow-hidden rounded-[var(--radius-sm)] border border-[var(--line-strong)] bg-[var(--paper-raised)] shadow-[var(--shadow-popover)] outline-none"
          >
            <input
              ref={searchRef}
              type="search"
